...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/prev/chaxun">
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/prev/infoadd" class="btn btn-success btn-sm">新增APP基础信息</a>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							role="status" aria-live="polite">共${fen.zongshu }条记录
							${fen.ye}/${fen.zongye}页</div>
					</div>
					<div class="col-sm-7">
							...
							<ul class="pagination">
								<c:if test="${fen.ye > 1}">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${fen.ye-1});"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">上一页</a>
									</li>
								</c:if>
								<c:if test="${fen.ye < fen.zongye }">
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${fen.ye+1 });"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">下一页</a>
									...
									<li class="paginate_button next"><a
										href="javascript:page_nav(document.forms[0],${fen.zongye });"
